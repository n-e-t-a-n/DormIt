    ...
    <View style={styles.container}>
      {reservations.map((reservation) => (
        <View key={reservation.reservation_id} style={styles.reservationContainer}>
          <Text style={styles.studentName}>{reservation.firstName} {reservation.lastName}</Text>
          <Text>Contact Details: {reservation.contactNo}</Text>
          <Text>Listing Name: {reservation.listingName}</Text>
          <View style={styles.buttonContainer}>
            <Button
              title="Accept"
              onPress={() => handleAcceptReservation(reservation.reservation_id)}
            />
            <Button
              title="Reject"
